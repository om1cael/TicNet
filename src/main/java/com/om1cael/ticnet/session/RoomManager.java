...
public class RoomManager {
    ...
    public void createRoom(Player host) {
        if(this.gamePlayers.containsKey(host) || host.getCurrentGame() != null) {
            ...
            host.writeClient(RoomResponses.ROOM_CREATION_ALREADY_PLAYING);
            return;
        }
        ...
        host.writeClient(RoomResponses.ROOM_CREATION_SUCCESSFUL);
    }
    ...
    public void joinRoom(Player guest, Player host) {
        if(guest.getCurrentGame() != null) {
            ...
            guest.writeClient(RoomResponses.ROOM_JOINING_ALREADY_PLAYING);
            return;
        }
        ...
        if(currentGuest != null && currentGuest.isPresent()) {
            ...
            guest.writeClient(RoomResponses.ROOM_JOINING_FULL_GAME);
            return;
        }
        ...
        if(game == null) {
            ...
            guest.writeClient(RoomResponses.ROOM_NOT_FOUND);
            return;
        }
        ...
        guest.writeClient(RoomResponses.ROOM_JOINING_SUCCESSFUL);
    }
    ...
    public void deleteRoom(Player player, boolean abruptStop) {
        ...
        actualHost.writeClient(RoomResponses.ROOM_DELETION_SUCCESSFUL);

        guest.ifPresent(client -> {
            client.setCurrentGame(null);
            client.writeClient(RoomResponses.ROOM_DELETION_SUCCESSFUL);
        });
